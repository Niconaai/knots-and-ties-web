export function renderOrderConfirmationEN(order: any, items: any[], shipping: any, appUrl: string) {
          ...
          <table style="max-width:680px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              <td style="padding:24px;">
                <h1 style="margin:0 0 12px 0;font-size:20px;color:#111827">Thanks for your order</h1>
                <p style="margin:0 0 16px 0;color:#374151">Reference: <strong>${order.paystack_reference}</strong></p>
                ...
                <h3 style="margin-top:18px;margin-bottom:8px;color:#111827">Shipping</h3>
                ...
                <p style="margin-top:20px;color:#6b7280">If you have any questions, reply to this email.</p>
              </td>
            </tr>
            <tr>
  ...
  return {
    subject: `Order confirmation — ${order.paystack_reference}`,
    html,
  }
}
